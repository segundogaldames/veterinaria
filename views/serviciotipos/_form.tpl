<form action="" method="post">
    <div class="mb-3">
        ...
        <input type="text" name="nombre" value="{$tipo.nombre|default:""}" class="form-control" id="" aria-describedby=""
    ...
    <div class="mb-3">
        <label for="precio" class="label text-success" style="font-weight: bold; font-size: 14px;">Precio (CLP) <span
                class="text-danger">*</span></label>
        <input type="number" name="precio" value="{$tipo.precio|default:""}" class="form-control" id=""
